...
<div class="main-content">
    <section class="section">
        ...
        <a href="{{ route('admin.distributor') }}" class="btn btn-icon icon-left btnwarning"> Kembali</a>
        <div class="card mt-4">
            <form action="{{ route('distributor.store') }}" class="needs-validation" method="POST">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
