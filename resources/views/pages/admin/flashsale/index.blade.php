...
@section('content')
    <div class="main-content">
        <section class="section">
            ...
            <a href="{{ route('flashsale.create') }}" class="btn btn-icon iconleft btn-primary">
                        ...
                        @forelse ($flashsales as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('flashsale.delete', $item->id) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="badge badgedanger"
                                            onclick="return confirm('Apakah Anda yakin ingin menghapus FlashSale ini?')">Hapus</button>
                                    </form>
                                </td>
                            </tr>
                        @empty
