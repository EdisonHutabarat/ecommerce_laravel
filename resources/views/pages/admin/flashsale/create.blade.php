...
@section('content')
    <div class="main-content">
        <section class="section">
            ...
            <a href="{{ route('admin.flashsale') }}" class="btn btn-icon iconleft btn-warning"> Kembali</a>
            <div class="card mt-4">
                <form action="{{ route('flashsale.store') }}" class="needsvalidation" novalidate=""
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="stock" type="number" class="formcontrol" name="stock" required="">
                                    <div class="invalid-feedback">
                                        Kolom ini harus di isi!
                                    </div>
                                </div>
                    ...
                    <button type="submit" class="btn btn-icon icon-left btnprimary">
                        <i class="fas fa-plus"></i> Tambah FlashSale
                    </button>
            </div>
            </form>
    </div>
